...
//        }
        ...
        if (req.getTotalAmount() == null || !req.getTotalAmount().equals(room.getPrice())) {
            throw new IllegalArgumentException("Invalid booking amount. It must match the room price: " + room.getPrice());
        }
...
//
//import com.booking_service.client.RoomClient;
//import com.booking_service.dto.ApiResponse;
//import com.booking_service.dto.BookingRequestDTO;
//import com.booking_service.dto.BookingResponseDTO;
//import com.booking_service.kafka.BookingProducer;
...
//    public ResponseEntity<ApiResponse<BookingResponseDTO>> getBookingById(Long bookingId, HttpServletRequest request) {
//        try {
...
//                    .orElseThrow(() -> new RuntimeException("Booking not found"));
//
//            if (!booking.getUser().getUserId().equals(userIdFromToken)) {
//                return ResponseEntity.status(HttpStatus.FORBIDDEN)
//                        .body(new ApiResponse<>(false, "You are not authorized to view this booking", null));
//            }
//
...
//                    .body(new ApiResponse<>(false, "Error while fetching booking: " + e.getMessage(), null));
//        }
//    }
//
//    public List<BookingResponseDTO> getBookingsByUser(Long userId) {
...
//    }
//
//    // ✅ Update Booking with Token Validation
//    public ResponseEntity<ApiResponse<BookingResponseDTO>> updateBooking(Long bookingId, BookingRequestDTO request, HttpServletRequest httpRequest) {
//        try {
...
//            if (!booking.getUser().getUserId().equals(userIdFromToken)) {
//                return ResponseEntity.status(HttpStatus.FORBIDDEN)
//                        .body(new ApiResponse<>(false, "You are not authorized to update this booking", null));
//            }
//
//            booking.setCheckInDate(request.getCheckInDate());
//            booking.setCheckOutDate(request.getCheckOutDate());
...
//
//            Booking updated = bookingRepository.save(booking);
//            return ResponseEntity.ok(new ApiResponse<>(true, "Booking updated successfully", mapToResponse(updated)));
//
//        } catch (Exception e) {
//            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
//                    .body(new ApiResponse<>(false, "Error updating booking: " + e.getMessage(), null));
//        }
//    }
//
//    // ✅ Delete Booking with Token Validation
//    public ResponseEntity<ApiResponse<String>> deleteBooking(Long bookingId, HttpServletRequest request) {
//        try {
//            String header = request.getHeader("Authorization");
//            if (header == null || !header.startsWith("Bearer ")) {
//                return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
...
//            if (!booking.getUser().getUserId().equals(userIdFromToken)) {
//                return ResponseEntity.status(HttpStatus.FORBIDDEN)
//                        .body(new ApiResponse<>(false, "You are not authorized to delete this booking", null));
//            }
//
//            bookingRepository.delete(booking);
